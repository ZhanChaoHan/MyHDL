...
public class SimpleBullet extends Bullet {
	...
	public SimpleBullet(FloatPoint position, int direction, int type, float speedX, float speedY) {
	...
	public void drawBubblet(Graphics2D g, float mapPosition) {
		if (isAlive) {
			...
			g.fillRoundRect((int) (this.position.x - mapPosition) * 3 - (int) this.size,
